...
| ------------------ | ----------------- | ------------------------ | ------------------------- |
| 2023.04 ~ 현재 | ㈜ 네오위즈 | 신작개발그룹 Onetake스튜디오 | c#서버, (ASP.Net)      |
| 2020.10 ~ 2023.01 | ㈜ 비비드스튜디오 | 게임개발본부  게임개발실 | ㈜ 엔씨엘오 사명변경<br />(c# 서버)    |
| 2019.12 ~ 2020.09  | ㈜ 웹젠           | 프로젝트C TFT            | (c# 서버)                    |
| 2017.09 ~ 2019.11  | ㈜ 웹젠온네트     | 프로그램실               | ㈜ 웹젠 자회사<br /> (c# 서버, 관리)       |
| 2016.01 ~ 2017.08  | ㈜ 아이덴티티     | 모바일본부 WOD팀         | (c++서버)                     |
| 2006.09 ~ 2016.01  | ㈜ 액토즈소프트   | 아비오스튜디오           | 자회사 ㈜ 플레이파이 포함<br />(DirectX 클라이언트) |
| 2000.02 ~ 2006.03  | ㈜ 팜팜인터테크   |                          | (DirectX 클라이언트)             |
|                    |                   |                          |                           |
...
| Framework  / Library  | C++ TCP server<br />C# TCP server<br />Asp.Net Server<br />Node.js(학습), <br />javascript webui (운영툴)<br />Blazor (운영툴) |
...
#### 던만추(던전에서 만남을 추구하면 안되는걸까) : 2023.04 ~2024.01, 개발 중단
* 팀구성 : 실장, PD, 시스템기획, 컨텐츠 기획, 연출 기획, 아트실, 클라이언트, 서버 (약 100여명)
* 담당업무
